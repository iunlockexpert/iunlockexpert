import{i as C,a as U,h as A,N as D,x as u,d as K,j as W,R as S,A as j,f as V,M,W as F,r as Q,k as q}from"./index-BEfLL5om.js";import{r as a,n as g,c as E,U as m}from"./if-defined-BlRFlHeJ.js";import"./index-DnFJtmQF.js";import{M as R}from"./index-DwYRKtVh.js";import"./index-KbsWA0s0.js";import{S as n}from"./index-B-RJT45s.js";import"./index-KUK2kSxP.js";import"./index-EBSkG4Aw.js";import"./index-CYbyFqvk.js";import"./index-Dz2JK-ei.js";import"./index-DXYNTzdi.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
