import{i as C,a as U,h as A,N as D,x as u,d as K,j as W,R as S,A as j,f as V,M,W as F,r as Q,k as q}from"./index-CLh2Yy6k.js";import{r as a,n as g,c as E,U as m}from"./if-defined-RlzeAByp.js";import"./index-dPrQ4hRi.js";import{M as R}from"./index-CHz_l-xo.js";import"./index-DJszL9RC.js";import{S as n}from"./index-BOPY9XqS.js";import"./index-DJwY6Nn0.js";import"./index-C25yorc2.js";import"./index-i7OZvCyg.js";import"./index-CzLvFK5t.js";import"./index-Cf2E6Nkb.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
