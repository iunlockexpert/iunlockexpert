import{i as N,a as k,x as a,r as L,h as v,G as p,f as O,R as Y,j as V,A as z,W as E,O as W}from"./index-Dtqq9JG_.js";import{n as l,c as _,o as S,r as b}from"./if-defined-DcyYj--N.js";import{T as A,D as F}from"./index-DAhsaUoB.js";import"./index-DzP8ahPJ.js";import"./index-BXB69zP8.js";import"./index-B7tJ2p-V.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
