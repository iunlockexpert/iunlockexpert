import{i as N,a as k,x as a,r as L,h as v,G as p,f as O,R as Y,j as V,A as z,W as E,O as W}from"./index-Dvri1Ep5.js";import{n as l,c as _,o as S,r as b}from"./if-defined-DEdztFfl.js";import{T as A,D as F}from"./index-BW8lDMEX.js";import"./index-BYNmb0OB.js";import"./index-C-1v9Qha.js";import"./index-CGiDZ5cM.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
