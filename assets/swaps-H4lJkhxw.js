import{i as C,a as U,h as A,N as D,x as u,d as K,j as W,R as S,A as j,f as V,M,W as F,r as Q,k as q}from"./index-Bmq8QDkI.js";import{r as a,n as g,c as E,U as m}from"./if-defined-D9M79GVC.js";import"./index-BsGxdIvg.js";import{M as R}from"./index-CZLQ9AAB.js";import"./index-BLWTvY0d.js";import{S as n}from"./index-ChWNbwBG.js";import"./index-qtR3rApI.js";import"./index-BSV7aP4w.js";import"./index-KdP-NSke.js";import"./index-BES8lcl3.js";import"./index-YRclVzSt.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
